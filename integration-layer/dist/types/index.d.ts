...
export interface BridgeEvent {
    type: "SYNC_STARTED" | "SYNC_COMPLETED" | "SYNC_FAILED" | "PROOF_VALIDATED" | "PROOF_INVALID" | "STATE_UPDATED";
    timestamp: number;
    details: Record<string, any>;
}
...
export declare class SolanaError extends IntegrationError {
    constructor(message: string, details?: Record<string, any>);
}
export declare class BridgeError extends IntegrationError {
    constructor(message: string, details?: Record<string, any>);
}
